...
public class SS_LeaderboardUI : MonoBehaviour
{
    [Header("Variables")]
    [SerializeField] float itemHeight = 50f;
    [SerializeField] int leaderboardEntriesUICount = 17;

    SS_LeaderboardModel leaderboardModel = null;
    ...
    [SerializeField] SS_ObjectsPool leaderboardEntryUIObjectsPool = null;

    List<SS_LeaderboardEntryUI> leaderboardEntriesUI = new List<SS_LeaderboardEntryUI>();
    ...
    public void OnLeaderboardUpdate(SS_GameEventData _gameEventData)
    {
        mineLeaderboardEntryModelId = _gameEventData.IntValues[0];
        leaderboardModel = _gameEventData.ObjectValues[0] as SS_LeaderboardModel;
    ...
    {
        SS_LeaderboardEntryUI _leaderBoardEntryUI = leaderboardEntryUIObjectsPool?.Get()?.GetComponent<SS_LeaderboardEntryUI>();
    ...
    {
        SS_LeaderboardEntryUI _leaderBoardEntryUI = leaderboardEntriesUI[0];
    ...
    private void focusOnItem(int _itemId)
    {
        ...
        {
            SS_LeaderboardEntryUI _leaderboardEntryUI = leaderboardEntriesUI[i];
            RectTransform _leaderboardEntryUITransform = _leaderboardEntryUI.transform as RectTransform;
    ...
    private void select(SS_LeaderboardEntryUI _leaderboardEntryUI, int _id, SS_LeaderboardEntryModel _leaderboardEntryModel, int _mineId)
    {
