...
public class SS_DrunkMovement : MonoBehaviour, SS_IMoveable
{
    [Header("Variables")]
    [SerializeField] float moveSpeed = 0f;
    [SerializeField] SS_MinMax movementRange = new SS_MinMax(0f, 0f);
    [SerializeField] SS_MinMax oneDirectionMoveDuration = new SS_MinMax(0f, 0f);
